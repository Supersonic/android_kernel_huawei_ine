...
#define HEADSET_DEBUG_REPORT_KEY(type) \
	do {\
		snd_soc_jack_report(g_headset_debug.jack, type, SND_JACK_BTN_0|SND_JACK_BTN_1|SND_JACK_BTN_2);\
		msleep(30);\
		snd_soc_jack_report(g_headset_debug.jack, 0, SND_JACK_BTN_0|SND_JACK_BTN_1|SND_JACK_BTN_2);\
	}while(0)
