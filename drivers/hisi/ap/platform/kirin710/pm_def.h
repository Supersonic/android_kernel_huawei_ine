...
#define SLT_SR_BASE_ADDR SOC_SCTRL_SCBAKDATA11_ADDR(SOC_ACPU_SCTRL_BASE_ADDR)
#elif defined(__CMSIS_RTOS)
#define SLT_SR_BASE_ADDR SOC_SCTRL_SCBAKDATA11_ADDR(SOC_LPMCU_SCTRL_BASE_ADDR)
#endif
