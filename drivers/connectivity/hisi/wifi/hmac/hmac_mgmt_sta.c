                                                                ...
                                                                hmac_user_stru      *pst_hmac_user)
{
    ...
    if (OAL_PTR_NULL != puc_ie)
    {
        ...
        if(uc_num_rates > WLAN_MAX_SUPP_RATES || uc_num_rates < MAC_MIN_RATES_LEN)
        {
...
oal_uint32 hmac_sta_wait_asoc_rx(hmac_vap_stru *pst_hmac_sta, oal_void *pst_msg)
{
...
#ifdef _PRE_WLAN_FEATURE_BTCOEX
    pst_hmac_user_ap->st_hmac_user_btcoex.st_hmac_btcoex_addba_req.uc_delba_enable = OAL_TRUE;
    ...
    if (OAL_TRUE == hmac_btcoex_check_exception_in_list(pst_hmac_sta, auc_addr_sa))
    {
        ...
        pst_hmac_user_ap->st_hmac_user_btcoex.st_hmac_btcoex_addba_req.uc_delba_enable = OAL_FALSE;
    }
#endif
