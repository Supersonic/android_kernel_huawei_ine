...
typedef struct
{
    ...
    oal_uint32 ul_rx_desc_rssi;             /*当前帧的rssi*/
    oal_uint32 ul_rpt_snr_ant1;             /*信噪比*/
    oal_uint32 ul_rpt_snr_ant0;             /*信噪比*/
    oal_uint32 ul_rpt_aver_evm_ant1;        /*平均evm*/
    oal_uint32 ul_rpt_aver_evm_ant0;        /*平均evm*/
    oal_uint32 ul_rpt_max_evm_ant1;         /*最大evm*/
    oal_uint32 ul_rpt_max_evm_ant0;         /*最大evm*/
    ...
    oal_uint32 ul_rx_dup_mpdu_cnt;          /*接受到的重复mpdu数量*/
    oal_uint32 ul_rx_passed_mpdu_cnt;       /*fcs正确的mpdu数量统计*/
    oal_uint32 ul_rx_failed_mpdu_cnt;       /*fcs错误的mpdu数量统计*/
    oal_uint32 ul_rx_beacon_cnt;            /*beacon帧接受数量统计*/
    oal_uint32 ul_rpt_ampdu_retry_cnt;      /*统计的硬件重传的ampdu次数*/
...
#endif
extern oal_void hi1151_set_extlna_chg_cfg(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_extlna_chg_bypass);
...
#endif
extern oal_void hi1102_set_extlna_chg_cfg(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_extlna_chg_bypass);
#ifdef _PRE_WLAN_FEATURE_EDCA_OPT
