...
extern oal_uint32 hmac_config_update_ip_filter(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param);
...
extern oal_uint32  hmac_config_set_auto_protection(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param);
...
#ifdef _PRE_WLAN_FEATURE_AUTO_FREQ
extern oal_void  hmac_set_device_freq_mode(oal_uint8 uc_device_freq_type);
extern oal_uint32 hmac_config_set_device_freq(oal_uint8 uc_device_freq_type);
#endif
#ifdef _PRE_WLAN_WAKEUP_SRC_PARSE
