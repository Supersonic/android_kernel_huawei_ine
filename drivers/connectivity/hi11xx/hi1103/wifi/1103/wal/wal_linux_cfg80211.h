...
#define WAL_MGMT_TX_TIMEOUT_MSEC        50     /* WAL 发送管理帧超时时间,100->50,减少host发送重传,防止发错信道 */
...
extern oal_void wal_cfg80211_reset_bands(oal_uint8 uc_dev_id);
extern oal_void wal_cfg80211_save_bands(oal_uint8 uc_dev_id);
