                ...
                mac_channel_list_stru                *pst_chan_info)
{
    switch (en_bandwidth)
    {
        ...
        case WLAN_BAND_WIDTH_160PLUSPLUSPLUS:
            ...
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx + 2];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx + 3];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx + 4];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx + 5];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx + 6];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 7];
            break;

        case WLAN_BAND_WIDTH_160PLUSPLUSMINUS:
            pst_chan_info->ul_channels = 8;
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx - 4];
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx - 3];
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx - 2];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx + 2];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 3];
            break;
        ...
        case WLAN_BAND_WIDTH_160PLUSMINUSPLUS:
            ...
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx + 2];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx + 3];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx + 4];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 5];
            break;

        case WLAN_BAND_WIDTH_160PLUSMINUSMINUS:
            pst_chan_info->ul_channels = 8;
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx - 6];
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx - 5];
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx - 4];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx - 3];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx - 2];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1];
            break;
        ...
        case WLAN_BAND_WIDTH_160MINUSPLUSPLUS:
            ...
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx + 2];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx + 3];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx + 4];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx + 5];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 6];
            break;

        case WLAN_BAND_WIDTH_160MINUSPLUSMINUS:
            pst_chan_info->ul_channels = 8;
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx - 5];
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx - 4];
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx - 3];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx - 2];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 2];
            break;
        ...
        case WLAN_BAND_WIDTH_160MINUSMINUSPLUS:
            ...
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx + 1];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx + 2];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx + 3];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx + 4];
            break;

        case WLAN_BAND_WIDTH_160MINUSMINUSMINUS:
            pst_chan_info->ul_channels = 8;
            pst_chan_info->ast_channels[0] = g_ast_freq_map_5g[uc_pri20_channel_idx - 7];
            pst_chan_info->ast_channels[1] = g_ast_freq_map_5g[uc_pri20_channel_idx - 6];
            pst_chan_info->ast_channels[2] = g_ast_freq_map_5g[uc_pri20_channel_idx - 5];
            pst_chan_info->ast_channels[3] = g_ast_freq_map_5g[uc_pri20_channel_idx - 4];
            pst_chan_info->ast_channels[4] = g_ast_freq_map_5g[uc_pri20_channel_idx - 3];
            pst_chan_info->ast_channels[5] = g_ast_freq_map_5g[uc_pri20_channel_idx - 2];
            pst_chan_info->ast_channels[6] = g_ast_freq_map_5g[uc_pri20_channel_idx - 1];
            pst_chan_info->ast_channels[7] = g_ast_freq_map_5g[uc_pri20_channel_idx];
            break;
    #endif
