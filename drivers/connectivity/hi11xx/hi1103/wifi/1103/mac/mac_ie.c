...
ITCM_EXT_T oal_uint32  mac_ie_parse_he_cap(oal_uint8 *puc_he_cap_ie, mac_frame_he_cap_ie_stru *pst_he_cap_value)
{
...
/*lint -save -e438 */
ITCM_EXT_T oal_uint32  mac_ie_parse_he_oper(oal_uint8 *puc_he_oper_ie,mac_frame_he_oper_ie_stru *pst_he_oper_ie_value)
{
...
ITCM_EXT_T oal_uint32  mac_ie_parse_mu_edca_parameter(oal_uint8 *puc_he_edca_ie,mac_frame_he_mu_edca_parameter_ie_stru *pst_he_mu_edca_value)
{
...
/*lint -save -e438 */
ITCM_EXT_T oal_uint32 mac_ie_parse_spatial_reuse_parameter(oal_uint8 *puc_he_srp_ie,mac_frame_he_spatial_reuse_parameter_set_ie_stru *pst_he_srp_value)
{
    oal_uint8                      *puc_he_buffer;
...
ITCM_EXT_T oal_uint32  mac_ie_proc_he_opern_ie(mac_vap_stru *pst_mac_vap,oal_uint8 *puc_payload,mac_user_stru *pst_mac_user)
{
...
ITCM_EXT_T oal_uint32  mac_ie_parse_he_bss_color_change_announcement_ie(oal_uint8 *puc_payload, mac_frame_bss_color_change_annoncement_ie_stru *pst_bss_color)
{
