...
mac_vap_cb  g_st_mac_vap_rom_cb = {mac_init_mib_rom_cb,
                                   ...
                                   OAL_PTR_NULL, //init_11ac_rates_cb
...
oal_uint32  mac_vap_add_assoc_user(mac_vap_stru *pst_vap, oal_uint16 us_user_idx)
{
    ...
    {
        OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_ASSOC, "{mac_vap_add_assoc_user::pst_user[%d] null.}", us_user_idx);
    ...
    if (WLAN_VAP_MODE_BSS_AP == pst_vap->en_vap_mode)
    {
        ...
        {
            OAM_WARNING_LOG0(0, OAM_SF_ASSOC, "{mac_vap_add_assoc_user::add_sta_to_assioc_list failed.}");
        }
    }
#endif
    ...
    else
    {
        ...
        else
        {
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_vap->ast_user_hash[ul_user_hash_value]))
            {
                ...
                if (OAL_PTR_NULL == pst_mac_user)
                {
                    OAM_ERROR_LOG1(pst_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_find_user_by_macaddr::pst_mac_user null.user idx %d}",pst_mac_user->us_assoc_id);
                    continue;
                }
                /*lint -restore */
                ...
                oal_uint16          *pus_user_idx)
{
    ...
    {
       // ul_ret = mac_device_find_user_by_macaddr(uc_device_idx, puc_sta_mac_addr, pus_user_idx);
        ul_ret = mac_device_find_user_by_macaddr(pst_mac_chip->auc_device_id[uc_device_idx], puc_sta_mac_addr, pus_user_idx);
        if(OAL_SUCC == ul_ret)
        {
            return OAL_SUCC;
        }
...
oal_void mac_vap_set_assoc_id(mac_vap_stru *pst_vap, oal_uint16 us_assoc_vap_id)
{
...
oal_void mac_vap_set_rx_nss(mac_vap_stru *pst_vap, wlan_nss_enum_uint8 en_rx_nss)
{
...
oal_uint32 mac_vap_save_app_ie(mac_vap_stru *pst_mac_vap, oal_app_ie_stru *pst_app_ie, en_app_ie_type_uint8 en_type)
{
    ...
    if ((pst_mac_vap->ast_app_ie[en_type].ul_ie_max_len < ul_ie_len) || (NULL == pst_mac_vap->ast_app_ie[en_type].puc_ie))
    {
        ...
        {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_save_app_ie::invalid len[%d].}",
        ...
        {
            OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_save_app_ie::LOCAL_MEM_POOL is empty!,len[%d], en_type[%d].}",
    ...
    OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_save_app_ie::IE:[0x%2x][0x%2x][0x%2x][0x%2x]}",
...
oal_void  mac_init_mib(mac_vap_stru *pst_mac_vap)
{
    ...
    if (OAL_PTR_NULL == pst_mac_dev)
    {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_init_mib::pst_mac_dev[%d] null.}", pst_mac_vap->uc_device_id);
        return;
    }
...
oal_void  mac_vap_change_mib_by_bandwidth(mac_vap_stru *pst_mac_vap, wlan_channel_band_enum_uint8 en_band,  wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
    wlan_mib_ieee802dot11_stru *pst_mib_info;
    ...
    if (OAL_PTR_NULL == pst_mib_info)
    {
        ...
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_change_mib_by_bandwidth::pst_mib_info null.}");
#else
...
oal_bool_enum_uint8  mac_vap_check_bss_cap_info_phy_ap(oal_uint16 us_cap_info,mac_vap_stru *pst_mac_vap)
{
    ...
    {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_check_bss_cap_info_phy_ap::PBCC is different.}");
    }
    ...
    {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_check_bss_cap_info_phy_ap::Channel Agility is different.}");
    }
    ...
    {
        OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_check_bss_cap_info_phy_ap::DSSS-OFDM Capabilities is different.}");
    }
...
oal_uint32 mac_vap_init_privacy(mac_vap_stru *pst_mac_vap, mac_conn_security_stru *pst_conn_sec)
{
...
oal_uint32 mac_mib_set_wep(mac_vap_stru *pst_mac_vap, oal_uint8 uc_key_id, oal_uint8 uc_key_value)
{
...
oal_uint8 mac_vap_get_default_key_id(mac_vap_stru *pst_mac_vap)
{
    ...
    if (OAL_PTR_NULL == pst_multi_user)
    {
        ...
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_WPA, "{mac_vap_get_default_key_id::multi_user[%d] NULL}",
            pst_mac_vap->us_multi_user_idx);
        return 0;
    }
