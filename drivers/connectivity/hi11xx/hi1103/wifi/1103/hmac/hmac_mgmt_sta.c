    ...
    switch (uc_mgmt_frm_type)
    {
        ...
        case WLAN_FC0_SUBTYPE_ACTION|WLAN_FC0_TYPE_MGT:
            ...
            /* 如果是Action 帧，则直接上报wpa_supplicant*/
            {
                ...
                pst_hmac_user = mac_vap_get_hmac_user_by_addr(&pst_hmac_vap_sta->st_vap_base_info, pst_frame_hdr->auc_address2);

                OAM_WARNING_LOG0(pst_hmac_vap_sta->st_vap_base_info.uc_vap_id, OAM_SF_RX, "{hmac_sta_not_up_rx_mgmt::MAC_ACTION_CATEGORY_WNM.}");
