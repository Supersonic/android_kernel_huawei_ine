...
oal_uint32 hmac_roam_connect_set_join_reg(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user)
{
...
OAL_STATIC oal_uint32 hmac_roam_process_assoc_rsp(hmac_roam_info_stru *pst_roam_info, oal_void *p_param)
{
    ...
    ul_ret = hmac_process_assoc_rsp(pst_hmac_vap, pst_hmac_user, puc_mac_hdr, us_hdr_len, puc_payload, us_msg_len);
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ROAM,
