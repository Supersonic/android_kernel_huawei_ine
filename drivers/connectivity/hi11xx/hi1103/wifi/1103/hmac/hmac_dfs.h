...
extern oal_void  hmac_dfs_cac_stop(mac_device_stru *pst_mac_device,mac_vap_stru *pst_mac_vap);
...
extern oal_void  hmac_dfs_radar_wait(mac_device_stru *pst_mac_device, hmac_vap_stru *pst_hmac_vap);
...
extern oal_bool_enum_uint8 hmac_dfs_try_cac(hmac_device_stru *pst_hmac_device, mac_vap_stru *pst_mac_vap);
...
OAL_STATIC OAL_INLINE oal_bool_enum_uint8  hmac_dfs_need_for_cac(mac_device_stru *pst_mac_device, mac_vap_stru *pst_mac_vap)
{
    ...
    /* 获取信道索引 */
    ul_ret = mac_get_channel_idx_from_num(MAC_RC_START_FREQ_5, pst_channel->uc_chan_number, &uc_idx);
