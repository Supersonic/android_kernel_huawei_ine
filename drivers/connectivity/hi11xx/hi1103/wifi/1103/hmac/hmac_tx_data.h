...
#define WLAN_DDC_THROUGHPUT_THRESHOLD_HIGH   100  /* 100Mb/s */
#define WLAN_DDC_THROUGHPUT_THRESHOLD_LOW    50  /* 50Mb/s */
...
#endif
extern oal_void hmac_rx_ddc_switch(oal_uint32 ul_rx_throughput_mbps);
