...
err_get_bfgx_power_gpio:
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_WIFI_DRV(CHR_WIFI_DEV_EVENT_CHIP, CHR_WIFI_DEV_ERROR_POWER_GPIO));
...
err_get_bfgx_wkup_host_gpio:
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_WIFI_DRV(CHR_WIFI_DEV_EVENT_CHIP, CHR_WIFI_DEV_ERROR_WAKEUP_GPIO));
...
int32 hi1103_wlan_power_off(void)
{
    ...
    if(OAL_SUCC != wlan_pm_poweroff_cmd())
    {
        ...
        CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_WIFI_DRV(CHR_WIFI_DRV_EVENT_PLAT, CHR_PLAT_DRV_ERROR_CLOSE_WCPU));
...
int32 hi1103_board_get_power_pinctrl(struct platform_device *pdev)
{
    ...
    if (OAL_IS_ERR_OR_NULL(pinctrl))
    {
        ...
        CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_WIFI_DEV(CHR_WIFI_DEV_EVENT_CHIP, CHR_WIFI_DEV_ERROR_IOMUX));
