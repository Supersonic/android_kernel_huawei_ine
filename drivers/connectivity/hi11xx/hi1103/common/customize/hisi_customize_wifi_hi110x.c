...
OAL_STATIC wlan_cfg_cmd g_ast_nvram_config_ini[NVRAM_PARAMS_PWR_INDEX_BUTT] =
{
    ...
    {"nvram_params59",                    NVRAM_PARAMS_INDEX_59},
    {"nvram_params60",                    NVRAM_PARAMS_INDEX_60},
    {"nvram_params61",                    NVRAM_PARAMS_INDEX_61},
...
OAL_STATIC oal_void original_value_for_nvram_params(oal_void)
{
    ...
    /* DPD 打开时高阶速率功率 */
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_59] = 0xE2ECEC00;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_60] = 0xE2E200E2;
    g_al_nvram_init_params[NVRAM_PARAMS_INDEX_61] = 0x0000C4C4;
    /* 基准发射功率 */
...
OAL_STATIC int32 hwifi_config_init_nvram(void)
{
    ...
    oal_memcopy(g_st_cust_nv_params.ac_dpd_delt_txpwr_params, al_nvram_params + NVRAM_PARAMS_INDEX_59, NUM_OF_NV_DPD_MAX_TXPOWER);
