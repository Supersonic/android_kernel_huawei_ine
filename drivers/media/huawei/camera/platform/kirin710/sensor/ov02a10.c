...
static bool s_ov02a10_power_on = false; //false for power down, ture for power up
struct mutex ov02a10_power_lock;
...
static struct sensor_power_setting ov02a10_power_down_setting[] = {
    //M1 RESET  [GPIO_12]
    {
        .seq_type = SENSOR_RST,
        .config_val = SENSOR_GPIO_LOW,
...
static sensor_t s_ov02a10 =
{
    ...
    .power_down_setting_array = {
        .size = ARRAY_SIZE(ov02a10_power_down_setting),
        .power_setting = ov02a10_power_down_setting,
    },
