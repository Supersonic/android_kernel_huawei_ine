...
#define COUL_IMONITOR_REPORT_INTERVAL_HOUR   0

/* imonitor no list */
#define COUL_IMONITOR_BASP_BASIC_INFO_NO 930001007
#define COUL_IMONITOR_CVT_BASIC_INFO_NO  930001009
