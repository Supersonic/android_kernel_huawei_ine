...
#define HISI_PMIC_VIBRATOR_HAPTIC_6_CYCLE       1
#define HISI_PMIC_VIBRATOR_HAPTIC_8_CYCLE       2
#define HISI_PMIC_VIBRATOR_HAPTIC_10_CYCLE      3
...
static s32 hisi_pmic_vibrator_haptic_cfg(struct hisi_pmic_vibrator_dev *vdev, u32 type)
{
	...
	switch(type) {
	case HISI_PMIC_VIBRATOR_HAPTIC_6_CYCLE:
		...
		break;
	case HISI_PMIC_VIBRATOR_HAPTIC_8_CYCLE:
		...
		break;
	case HISI_PMIC_VIBRATOR_HAPTIC_10_CYCLE:
