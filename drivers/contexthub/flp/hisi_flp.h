...
#define FD_IOCTL_CELLBATCHING_CONFIG              (FLP_IOCTL_TAG_FLP + 0x46)
#define FD_IOCTL_CELLBATCHING_REQUEST             (FLP_IOCTL_TAG_FLP + 0x47)
...
/***************wififence -b********************/
#define WIFI_BSSID_NUM        (6)
#define MAX_ADD_WIFI_NUM      (100)
