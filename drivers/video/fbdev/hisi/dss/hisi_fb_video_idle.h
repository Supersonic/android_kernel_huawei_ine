...
void hisifb_video_idle_wb_clear(struct hisi_fb_data_type *hisifd);
void hisifb_hisync_disp_sync_en(struct hisi_fb_data_type *hisifd);
bool hisifb_hisync_disp_sync_config(struct hisi_fb_data_type *hisifd);
