...
static struct ctl_table kern_table[] = {
	...
	{
		.procname	= "sched_early_detection_heavy_task_duration",
		.data		= &sysctl_sched_ed_heavy_task_duration,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
	...
	{
		.procname	= "sched_early_detection_waiting_task_duration",
		.data		= &sysctl_sched_ed_waiting_task_duration,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
	...
	{
		.procname	= "sched_early_detection_new_task_duration",
		.data		= &sysctl_sched_ed_new_task_duration,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
