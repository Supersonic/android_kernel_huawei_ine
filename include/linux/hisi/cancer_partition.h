...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_BOOTFAIL_INFO,    331*1024,  2*1024,        EMMC_USER_PART},/* bootfail info   2MB    p22*/
  ...
  {PART_RESERVED3_A,      482560,    7936,          EMMC_USER_PART},/* reserved3A   7936KB    p28*/
  {PART_IVP,              479*1024,  2*1024,        EMMC_USER_PART},/* ivp             2MB    p29*/
...
#endif
  {PART_RAMDISK_A,          662*1024,  16*1024,     EMMC_USER_PART},/* ramdisk         16M    p45*/
  {PART_RESERVED,           678*1024,   4*1024,     EMMC_USER_PART},/* reserved        16M    p46*/
  {PART_RECOVERY_RAMDISK_A, 682*1024,  32*1024,     EMMC_USER_PART},/* recovery_ramdisk 32M   p47*/
  {PART_RECOVERY_VENDOR_A,  714*1024,  16*1024,     EMMC_USER_PART},/* recovery_vendor 16M    p48*/
  {PART_DTS_A,              730*1024,   1*1024,     EMMC_USER_PART},/* dtimage         1M     p49*/
  {PART_DTO_A,              731*1024,  20*1024,     EMMC_USER_PART},/* dtoimage       20M     p50*/
  {PART_TRUSTFIRMWARE_A,    751*1024,  2*1024,      EMMC_USER_PART},/* trustfirmware   2M     p51*/
  {PART_MODEM_FW_A,         753*1024,  56*1024,     EMMC_USER_PART},/* modem_fw        56M    p52*/
  {PART_MODEM_PATCH_NV_A,   809*1024,   4*1024,     EMMC_USER_PART},/* modem_patch_nv_a  4M   p53*/
  {PART_MODEM_DRIVER_A,     813*1024,  20*1024,     EMMC_USER_PART},/* modem_driver_a   20M   p54*/
  {PART_RESERVED4_A,        833*1024,  23*1024,     EMMC_USER_PART},/* reserved4A      23M    p55*/
  ...
  {PART_VENDOR_A,           928*1024,          1232*1024,   EMMC_USER_PART},/* vendor         1232M   p62*/
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_FW_LPM3_A,        463*1024,  256,           UFS_PART_3},/* mcuimage        256K   p23*/
  {PART_RESERVED3_A,      474368,    7936,          UFS_PART_3},/* reserved3A      7936K  p24*/
  {PART_IVP,              471*1024,  2*1024,        UFS_PART_3},/* PART_IVP        2M     p25*/
  ...
  {PART_HHEE_A,           478*1024,  4*1024,        UFS_PART_3},/* PART_RESERVED10  4M    p28*/
...
#endif
  {PART_RAMDISK_A,          654*1024,  16*1024,     UFS_PART_3},/* ramdisk          16M    p41*/
  {PART_RESERVED,           670*1024,   4*1024,     UFS_PART_3},/* ramdisk           4M    p42*/
  {PART_RECOVERY_RAMDISK_A, 674*1024,  32*1024,     UFS_PART_3},/* recovery_ramdisk 32M    p43*/
  {PART_RECOVERY_VENDOR_A,  706*1024,  16*1024,     UFS_PART_3},/* recovery_vendor  16M    p44*/
  {PART_DTS_A,              722*1024,   1*1024,     UFS_PART_3},/* dtimage           1M    p45*/
  {PART_DTO_A,              723*1024,  20*1024,     UFS_PART_3},/* dtoimage         20M    p46*/
  {PART_TRUSTFIRMWARE_A,    743*1024,  2*1024,      UFS_PART_3},/* trustfirmware     2M    p47*/
  {PART_MODEM_FW_A,         745*1024,  56*1024,     UFS_PART_3},/* modem_fw         56M    p48*/
  {PART_MODEM_PATCH_NV_A,   801*1024,   4*1024,     UFS_PART_3},/* modem_patch_nv_a  4M    p49*/
  {PART_MODEM_DRIVER_A,     805*1024,  20*1024,     UFS_PART_3},/* modem_driver_a   20M    p50*/
  {PART_RESERVED4_A,        825*1024,  23*1024,     UFS_PART_3},/* reserved4A       253M   p51*/
  ...
  {PART_PRELOAD_A,          9544*1024, 1144*1024,      UFS_PART_3},/* preload      1144M   p64*/
  ...
  {PART_PRELOAD_A,          9368*1024, 1144*1024,       UFS_PART_3},/* version      1144M  p64*/
  {PART_USERDATA,          10512*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata        4G   p65*/
#else
  {PART_SYSTEM_A,           2536*1024, 5520*1024,      UFS_PART_3},/* system       5520M   p61*/
  {PART_PRODUCT_A,          8056*1024, 912*1024,       UFS_PART_3},/* product       192M   p62*/
  {PART_VERSION_A,          8968*1024, 576*1024,       UFS_PART_3},/* version       576M   p63*/
  {PART_PRELOAD_A,          9544*1024, 1144*1024,      UFS_PART_3},/* version      1144M   p64*/
