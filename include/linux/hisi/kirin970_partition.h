...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_DTS_A,            618*1024,  20*1024,       EMMC_USER_PART},/* dtimage         12M    p46*/
  {PART_DTO_A,            638*1024,   8*1024,       EMMC_USER_PART},/* dtoimage        4M     p47*/
  {PART_TRUSTFIRMWARE_A,  646*1024,  2*1024,        EMMC_USER_PART},/* trustfirmware   2M     p48*/
  {PART_MODEM_FW_A,       648*1024,  56*1024,       EMMC_USER_PART},/* modem_fw        56M    p49*/
  {PART_RESERVED4_A,      704*1024,  8*1024,       EMMC_USER_PART},/* reserved4A      20M    p50*/
  ...
  {PART_PRODUCT_A,        2264*1024, 192*1024,      EMMC_USER_PART},/* product         240M   p63*/
  {PART_SYSTEM_A,         2456*1024, 4560*1024,     EMMC_USER_PART},/* system          4560M  p64*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        7016*1024, 128*1024,      EMMC_USER_PART},/* reserved5       128M   p65*/
  {PART_HIBENCH_DATA,   7144*1024, 512*1024,        EMMC_USER_PART},/* hibench_data    512M   p66*/
  {PART_USERDATA,         7656*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p67*/
  #else
  ...
  {PART_PRODUCT_A,        2264*1024, 192*1024,      EMMC_USER_PART},/* product         192M   p63*/
  {PART_SYSTEM_A,         2456*1024, 5440*1024,     EMMC_USER_PART},/* system          5440M  p64*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        7896*1024, 128*1024,       EMMC_USER_PART},/* reserved5      64M    p65*/
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_DTS_A,            610*1024,  20*1024,       UFS_PART_3},/* dtimage         12M    p42*/
  {PART_DTO_A,            630*1024,   8*1024,       UFS_PART_3},/* dtoimage         4M    p43*/
  {PART_TRUSTFIRMWARE_A,  638*1024,  2*1024,        UFS_PART_3},/* trustfirmware   2M     p44*/
  {PART_MODEM_FW_A,       640*1024,  56*1024,       UFS_PART_3},/* modem_fw        56M    p45*/
  {PART_RESERVED4_A,      696*1024,  8*1024,       UFS_PART_3},/* reserved4A       20M    p46*/
  ...
  {PART_VENDOR_A,         832*1024,  952*1024,      UFS_PART_3},/* vendor          784M   p54*/
  {PART_PRELOAD_A,        1784*1024,   8*1024,      UFS_PART_3},/* product         8M   p55*/
  {PART_CUST_A,           1792*1024, 192*1024,      UFS_PART_3},/* cust            192M   p56*/
  {PART_ODM_A,            1984*1024,  144*1024,     UFS_PART_3},/* odm            128M    p57*/
  #ifdef CONFIG_HISI_CACHE_OVERSEA
  {PART_CACHE,            2128*1024,  1300*1024,     UFS_PART_3},/* cache          1300M    p58*/
  {PART_PRODUCT_A,        3428*1024, 192*1024,      UFS_PART_3},/* product         192M   p59*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         3620*1024, 4560*1024,     UFS_PART_3},/* system          3552M  p60*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        8180*1024, 128*1024,       UFS_PART_3},/* reserved5       128M  p61*/
  {PART_HIBENCH_DATA,   8308*1024, 512*1024,       UFS_PART_3},/* hibench_data      512M  p62*/
  {PART_USERDATA,         8820*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p63*/
  #else
  {PART_USERDATA,         8180*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #endif
  #else
  {PART_SYSTEM_A,         3620*1024, 5440*1024,     UFS_PART_3},/* system          4688M  p60*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        9060*1024, 128*1024,       UFS_PART_3},/* reserved5     128M    p61*/
  {PART_HIBENCH_DATA,   9188*1024, 512*1024,       UFS_PART_3},/* hibench_data    512M    p62*/
  {PART_USERDATA,         9700*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p63*/
  #else
  ...
  {PART_PRODUCT_A,        2256*1024, 192*1024,      UFS_PART_3},/* product         192M   p59*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2448*1024, 4560*1024,     UFS_PART_3},/* system          3552M  p60*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        7008*1024, 128*1024,       UFS_PART_3},/* reserved5       128M  p61*/
  {PART_HIBENCH_DATA,   7136*1024, 512*1024,       UFS_PART_3},/* hibench_data      512M  p62*/
  {PART_USERDATA,         7648*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p63*/
  #else
  {PART_USERDATA,         7008*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #endif
  #else
  {PART_SYSTEM_A,         2448*1024, 5440*1024,     UFS_PART_3},/* system          4688M  p60*/
  #ifdef CONFIG_FACTORY_MODE
