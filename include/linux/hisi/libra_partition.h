...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_RESERVED4_A,        708*1024,  12*1024,     EMMC_USER_PART},/* reserved4A      20M    p50*/
  {PART_PRELOAD_A,          720*1024,  8*1024,      EMMC_USER_PART},/* preload         8M     p51*/
  {PART_RECOVERY_VBMETA_A,  728*1024,  2*1024,      EMMC_USER_PART},/* recovery_vbmeta_a 2M   p52*/
  {PART_ERECOVERY_VBMETA_A, 730*1024,  2*1024,      EMMC_USER_PART},/* erecovery_vbmeta_a 2M  p53*/
  {PART_VBMETA_A,           732*1024,  4*1024,      EMMC_USER_PART},/* PART_VBMETA_A   4M     p54*/
  {PART_MODEMNVM_UPDATE_A,  736*1024,  16*1024,     EMMC_USER_PART},/* modemnvm_update_a 16M  p55*/
  {PART_MODEMNVM_CUST_A,    752*1024,  16*1024,     EMMC_USER_PART},/* modemnvm_cust_a 16M    p56*/
  {PART_PATCH_A,            768*1024,  32*1024,     EMMC_USER_PART},/* patch           32M    p57*/
  ...
  #else
  {PART_SYSTEM_A,           2256*1024, 4988*1024,      EMMC_USER_PART},/* system          4988M  p64*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,          7244*1024, 128*1024,       EMMC_USER_PART},/* reserved5      128M    p65*/
  {PART_HIBENCH_DATA,       7372*1024, 512*1024,       EMMC_USER_PART},/* hibench_data   512M    p66*/
  {PART_FLASH_AGEING,       7884*1024, 512*1024,       EMMC_USER_PART},/* flash_ageing   512M    p67*/
  {PART_USERDATA,           8396*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G      p68*/
  #else
  {PART_USERDATA,           7244*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G    p65*/
  #endif
  #endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_RESERVED4_A,        700*1024,  12*1024,     UFS_PART_3},/* reserved4A       20M    p46*/
  {PART_PRELOAD_A,          712*1024,  8*1024,      UFS_PART_3},/* preload          8M     p47*/
  {PART_RECOVERY_VBMETA_A,  720*1024,  2*1024,      UFS_PART_3},/* recovery_vbmeta_a  2M   p48*/
  {PART_ERECOVERY_VBMETA_A, 722*1024,  2*1024,      UFS_PART_3},/* erecovery_vbmeta_a 2M   p49*/
  {PART_VBMETA_A,           724*1024,  4*1024,      UFS_PART_3},/* vbmeta_a         4M     p50*/
  {PART_MODEMNVM_UPDATE_A,  728*1024,  16*1024,     UFS_PART_3},/* modemnvm_update_a  16M  p51*/
  {PART_MODEMNVM_CUST_A,    744*1024,  16*1024,     UFS_PART_3},/* modemnvm_cust_a    16M  p52*/
  {PART_PATCH_A,            760*1024,  32*1024,     UFS_PART_3},/* patch            32M    p53*/
  {PART_VERSION_A,          792*1024,  32*1024,     UFS_PART_3},/* version          32M    p54*/
  {PART_VENDOR_A,           824*1024,  760*1024,    UFS_PART_3},/* vendor           760M   p55*/
  {PART_PRODUCT_A,          1584*1024, 192*1024,    UFS_PART_3},/* product          192M   p56*/
  {PART_CUST_A,             1776*1024, 192*1024,    UFS_PART_3},/* cust             192M   p57*/
  {PART_ODM_A,              1968*1024, 176*1024,    UFS_PART_3},/* odm              176M   p58*/
  {PART_CACHE,              2144*1024, 104*1024,    UFS_PART_3},/* cache            104M   p59*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,           2248*1024, 3088*1024,      UFS_PART_3},/* system         3088M  p60*/
  {PART_USERDATA,           5336*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #elif defined CONFIG_MARKET_OVERSEA
  {PART_SYSTEM_A,           2248*1024, 3536*1024,      UFS_PART_3},/* system         3536M  p60*/
  {PART_USERDATA,           5784*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #elif defined CONFIG_MARKET_FULL_OVERSEA
  {PART_SYSTEM_A,           2248*1024, 5632*1024,      UFS_PART_3},/* system          5632M  p60*/
  {PART_USERDATA,           7880*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #elif defined CONFIG_MARKET_FULL_INTERNAL
  {PART_SYSTEM_A,           2248*1024, 4752*1024,      UFS_PART_3},/* system          4752M  p60*/
  {PART_USERDATA,           7000*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #else
  {PART_SYSTEM_A,           2248*1024, 4988*1024,      UFS_PART_3},/* system          4988M  p60*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,          7236*1024, 128*1024,       UFS_PART_3},/* reserved5        128M   p61*/
  {PART_HIBENCH_DATA,       7364*1024, 512*1024,       UFS_PART_3},/* hibench_data     512M   p62*/
  {PART_FLASH_AGEING,       7876*1024, 512*1024,       UFS_PART_3},/* flash_ageing     512M   p63*/
  {PART_USERDATA,           8388*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G       p64*/
  #else
  {PART_USERDATA,           7236*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p61*/
  #endif
  #endif
  {"0", 0, 0, 0},
};
