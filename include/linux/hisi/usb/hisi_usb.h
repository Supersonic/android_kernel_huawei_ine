...
static inline int hisi_usb_otg_event_sync(TCPC_MUX_CTRL_TYPE mode_type, enum otg_dev_event_type event_type, TYPEC_PLUG_ORIEN_E typec_orien)
{
	return 0;
}
...
int hisi_usb_otg_use_hifi_ip_first(void){return 0;}
int hisi_usb_otg_get_typec_orien(void){return 0;}
