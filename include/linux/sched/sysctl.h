...
extern unsigned int sysctl_sched_ed_heavy_task_duration;
extern unsigned int sysctl_sched_ed_waiting_task_duration;
extern unsigned int sysctl_sched_ed_new_task_duration;
#endif
#endif
